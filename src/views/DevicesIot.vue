...
export default {
  ...
  data() {
    return {
      ...
      /** @type {Map<Symbol, import('./js/DevicesIotDTO').UIState>} */
      initStateData: null,
      /** @type {String} */
      additionalText: '',
  ...
  computed: {
    ...
    isInServer() {
      return (
        this.hasServerExistingConfig ||
        (this.outputs.length > 0 && this.outputs.every(({ id }) => !!id))
      )
    },
    stateData() {
